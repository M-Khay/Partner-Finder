	...
	public void setupSearchPrefs()
	{
		try 
		{
			...
			else
			{
				int value = SexActivity.me.search.getInt("looking_for");
		  		...
		  		if(value != 0)
		  		{
		  			if((SexActivity.attributesGenderMan & value) != 0)
		  				newValueIwant += ((newValueIwant.equals("")==true) ? "" : ", ") + getString(R.string.gender_man);
		  			
		  			if((SexActivity.attributesGenderWoman & value) != 0)
		  				newValueIwant += ((newValueIwant.equals("")==true) ? "" : ", ") + getString(R.string.gender_woman);
		  			
		  			if((SexActivity.attributesGenderPairStraight & value) != 0)
		  				newValueIwant += ((newValueIwant.equals("")==true) ? "" : ", ") + getString(R.string.gender_pair_straight);
		  			
		  			if((SexActivity.attributesGenderPairLesbian & value) != 0)
		  				newValueIwant += ((newValueIwant.equals("")==true) ? "" : ", ") + getString(R.string.gender_pair_lesbian);
		  			
		  			if((SexActivity.attributesGenderPairGay & value) != 0)
		  				newValueIwant += ((newValueIwant.equals("")==true) ? "" : ", ") + getString(R.string.gender_pair_gay);
			  		
		  		}
			}
		  		
		  	if(newValueIwant.equals("") == false)
		  		filter_lookingfor_input.setText(newValueIwant);
	  		...
	  		{
	  			filter_age_input.setText(SexActivity.me.search.getString("age_from") + "-" + SexActivity.me.search.getString("age_to"));
	  		}
