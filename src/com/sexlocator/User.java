...
public class User 
{
	...
	public User(int pId, String pSession, String pNickname, int pGender, int pIwant, String pImage, String pDob, String pCountry, int pCredits, int pPremium, int pHideOnMap, int pHideOnSearch, int pTermsAgreed, JSONObject otherData) throws JSONException
	{
		id = pId;
		session = pSession;
		nickname = pNickname;
	...
	public void setUserDob()
	{
		...
		// Log.e("com.sexlocator.user.age", "age: " + age);
	}
}
