...
public class IntroActivity extends SexActivity
{
	...
	{
		if(SexActivity.me.nickname.equals("") == false && SexActivity.me.terms_agreed == 1 && SexActivity.me.age >= 18)
		{
	...
	private boolean isMyServiceRunning()
	{
	    ...
	    {
	        if("com.sexlocator.LocalService".equals(service.service.getClassName()))
	        	return true;
